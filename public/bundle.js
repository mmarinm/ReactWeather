...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: "examples", component: _Examples.Examples }),
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _Weather.Weather })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WeatherResult = __webpack_require__(219);
	...
	var Weather = exports.Weather = function (_React$Component) {
	  ...
	  _createClass(Weather, [{
	    ...
	    value: function handleSearch(location) {
	      ...
	      var that = this;
	      (0, _openWeatherMap.getTemp)(location).request.then(function (data) {
	        that.setState({
	          location: data.name,
	          temp: data.main.temp
	        });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_WeatherForm.WeatherForm, { onSearch: this.handleSearch.bind(this) }),
	        _react2.default.createElement(_WeatherResult.WeatherResult, { data: this.state })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherForm = exports.WeatherForm = function (_React$Component) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WeatherResult = undefined;
	...
	var WeatherResult = exports.WeatherResult = function (_React$Component) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=b3abacf38c70be5888237eb1649986fe&units=imperial';
	...
	function getTemp(location) {
	  ...
	  var request = _axios2.default.get(requestUrl).then(function (res) {
